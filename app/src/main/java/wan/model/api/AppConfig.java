...
public class AppConfig {
    ...
    public static final String DOWNLOAD_URL = "http://yixin.dl.126.net/update/installer/yixin.apk";
    ...
    public static final String BASE_URL_PIC = "http://cangsheng77.cn/";
     ...
     * 登录
     */
    public static final String LOGIN = API + USER + "register";
    /**
     * 快速入口
     */
    public static final String FASTENTRANCE = API + "fast_track";
    /**
     * 娃娃机列表
     */
    public static final String MACHINELIST = API + PRIZECLAW + "prize_claw_list";
    /**
     * 用户信息
     */
    public static final String GETUSERINFO = API + USER + "personal_info";
